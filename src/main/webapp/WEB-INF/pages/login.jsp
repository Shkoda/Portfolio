                    ...
                    <form role="form" name='f' action="/login" method='POST'>
                        <fieldset>
                            ...
                            <div class="form-group">
                                <input class="form-control" placeholder="Login" name="username" id="username" type='text' autofocus>
                            </div>
                            <div class="form-group">
                                <input class="form-control" placeholder="Password" name="password" id="password" type='text' value="">
                            </div>
                            <div class="checkbox">
                                <label>
